...
import CalisthenicsGame from './pages/CalisthenicsGame';
  ...
  return (
    <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
      ...
      <Routes>
        ...
        <Route path="/game" element={isAuthenticated ? <CalisthenicsGame setAuth={setIsAuthenticated} /> : <Navigate to="/login" />} />
